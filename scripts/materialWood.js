var materialList = {
  darkWood : {
    inputTextureColor : "./assets/texture/dark_wood/dark_wood_color.jpg",
    inputTextureNormal : "./assets/texture/dark_wood/dark_wood_normal.jpg",
    inputTextureRoughness : "./assets/texture/dark_wood/dark_wood_roughness.jpg",
    inputTextureScale : 2,
    name : "dark_wood"
  },
  lightWood : {
    inputTextureColor : "./assets/texture/light_wood/light_wood_color.jpg",
    inputTextureNormal : "./assets/texture/light_wood/light_wood_normal.jpg",
    inputTextureRoughness : "./assets/texture/light_wood/light_wood_roughness.jpg",
    inputTextureScale : 2,
    name : "light_wood"
  },
  hardWood : {
    inputTextureColor : "./assets/texture/hard_wood/hard_wood_color.jpg",
    inputTextureNormal : "./assets/texture/hard_wood/hard_wood_normal.jpg",
    inputTextureRoughness : "./assets/texture/hard_wood/hard_wood_roughness.jpg",
    inputTextureScale : 2,
    name : "hard_wood"
  }
}
  var dark_wood = new BABYLON.NodeMaterial(materialList.darkWood.name);
  // InputBlock
  ...
  scaleTexture.value = materialList.darkWood.inputTextureScale;
  scaleTexture.min = 0;
  scaleTexture.max = 0;
  ...
  roughnessTexture.texture = new BABYLON.Texture(materialList.darkWood.inputTextureRoughness, null, false, false);
  ...
  baseTexture.texture = new BABYLON.Texture(materialList.darkWood.inputTextureColor, null, false, false);
  ...
  normalTexture.texture = new BABYLON.Texture(materialList.darkWood.inputTextureNormal, null, false, false);
  ...
  var darkwoodMaterial = dark_wood.build();

  // // //////////////////////////

  var light_wood = new BABYLON.NodeMaterial(materialList.lightWood.name);
  // InputBlock
  var position = new BABYLON.InputBlock("position");
  position.setAsAttribute("position");
  ...
  // InputBlock
  var scaleTexture = new BABYLON.InputBlock("scaleTexture");
  scaleTexture.value = materialList.lightWood.inputTextureScale;
  scaleTexture.min = 0;
  scaleTexture.max = 0;
  scaleTexture.isBoolean = false;
  scaleTexture.matrixMode = 0;
  ...
  // TextureBlock
  var roughnessTexture = new BABYLON.TextureBlock("roughnessTexture");
  roughnessTexture.texture = new BABYLON.Texture(materialList.lightWood.inputTextureRoughness, null, false, false);
  roughnessTexture.texture.wrapU = 1;
  roughnessTexture.texture.wrapV = 1;
  roughnessTexture.texture.uAng = 0;
  roughnessTexture.texture.vAng = 0;
  ...
  // TextureBlock
  var baseTexture = new BABYLON.TextureBlock("baseTexture");
  baseTexture.texture = new BABYLON.Texture(materialList.lightWood.inputTextureColor, null, false, false);
  baseTexture.texture.wrapU = 1;
  baseTexture.texture.wrapV = 1;
  baseTexture.texture.uAng = 0;
  baseTexture.texture.vAng = 0;
  ...
  // TextureBlock
  var normalTexture = new BABYLON.TextureBlock("normalTexture");
  normalTexture.texture = new BABYLON.Texture(materialList.lightWood.inputTextureNormal, null, false, false);
  normalTexture.texture.wrapU = 1;
  normalTexture.texture.wrapV = 1;
  normalTexture.texture.uAng = 0;
  normalTexture.texture.vAng = 0;
  ...
  // Output nodes
 light_wood.addOutputNode(VertexOutput);
  light_wood.addOutputNode(FragmentOutput);
  var lightwoodMaterial = light_wood.build();

  // // //////////////////////////

  var hard_wood = new BABYLON.NodeMaterial(materialList.hardWood.name);
  // InputBlock
  var position = new BABYLON.InputBlock("position");
  position.setAsAttribute("position");
  ...
  // TextureBlock
  var roughnessTexture = new BABYLON.TextureBlock("roughnessTexture");
  roughnessTexture.texture = new BABYLON.Texture(materialList.hardWood.inputTextureRoughness, null, false, false);
  roughnessTexture.texture.wrapU = 1;
  roughnessTexture.texture.wrapV = 1;
  roughnessTexture.texture.uAng = 0;
  roughnessTexture.texture.vAng = 0;
  ...
  // TextureBlock
  var baseTexture = new BABYLON.TextureBlock("baseTexture");
  baseTexture.texture = new BABYLON.Texture(materialList.hardWood.inputTextureColor, null, false, false);
  baseTexture.texture.wrapU = 1;
  baseTexture.texture.wrapV = 1;
  baseTexture.texture.uAng = 0;
  baseTexture.texture.vAng = 0;
  ...
  // TextureBlock
  var normalTexture = new BABYLON.TextureBlock("normalTexture");
  normalTexture.texture = new BABYLON.Texture(materialList.hardWood.inputTextureNormal, null, false, false);
  normalTexture.texture.wrapU = 1;
  normalTexture.texture.wrapV = 1;
  normalTexture.texture.uAng = 0;
  normalTexture.texture.vAng = 0;
  ...
  // Output nodes
 hard_wood.addOutputNode(VertexOutput);
  hard_wood.addOutputNode(FragmentOutput);
  var hardwoodMaterial = hard_wood.build();
